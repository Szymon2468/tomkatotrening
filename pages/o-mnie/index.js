  ...
  return (
    <>
      <NextSeo
        ...
        description='tomkatotrening - dowiedz się więcej o mnie'
        canonical='https://www.tomkatotrening.pl/o-mnie'
      />
              ...
              <div className={classNames(styles.tile, styles.firstTile)}>
                ...
                <div className={styles.textList}>
                  ...
                  <ul>
                    ...
                    <li>
                      Opiekun i kierownik placówek wypoczynku dzieci i
                      młodzieży.
                    </li>
                  </ul>
                </div>
            ...
            <div className={styles.lightBg}>
              <div className='container'>
                <div className={classNames(styles.tile, styles.midTile)}>
                  ...
                  <div className={styles.textList}>
                    <p>
                      Podczas krótkiej przygody w rywalizacji sportowej udało
                      się wywalczyć:
                    </p>
                    <ul>
                      <li>
                      ...
                      <li>
                        III miejsce na Mistrzostwach Polski w Kata, Oświęcim
                        2003,
                      </li>
                      <li>
                      ...
                      <li>
                        I miejsce na Mistrzostwach Polski w Kumite, Osielsko
                        2006,
                      </li>
                      <li>
