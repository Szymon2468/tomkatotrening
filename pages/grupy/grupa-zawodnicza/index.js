...
const text = (
  <>
    ...
    <ul>
      <li>
        dużo ćwiczeń budujących i rozwijających wytrzymałość, szybkość i siłę, a
        także gibkość, skoczność czy koordynację ruchową,
      </li>
      <li>
        nacisk na technikę użytkową (sportową i nie tylko), poruszanie się,
        garda, techniki rąk oraz nóg, praca kombinacyjna na podstawie poznanych
        technik,
      </li>
      <li>
