  ...
  return (
    <>
      <NextSeo
        ...
        canonical='https://www.tomkatotrening.pl/informacji/fitness'
      />
        ...
        <div className='container'>
          <div className={styles.textAndImgContainer}>
            ...
            <div className={styles.text}>
              <p>
                Fitness to styl życia przejawiający się troską o szeroko
                pojmowane zdrowie i sprawność fizyczną. W takim stylu życia
                niewątpliwie istotną rolę odgrywa świadoma i systematyczna
                aktywność fizyczna, która może być realizowana pod postacią
                różnego rodzaju ćwiczeń. Aby zwiększyć efektywność naszych
                działań w dbałości o zdrowie i sprawność fizyczną istotne jest
                aby dobrać właściwą formę aktywności fizycznej, na której opiera
                się trening fitness, do naszych potrzeb.
              </p>
              <br />
              <p>
          ...
          <div className={classNames(styles.text, styles.secText)}>
            <span>
              ...
              <ul>
                ...
                <li>
                  zmniejszenie ryzyka zachorowania na cukrzycę poprzez
