  ...
  return (
    <>
      <NextSeo
        ...
        description='tomkatotrening - harmonogram zajęć'
        canonical='https://www.tomkatotrening.pl/informacje/harmonogram'
      />
      <GeneraslInfoPage name={'HARMONOGRAM'}>
        <div className='container'>
            ...
            <div className={styles.filters}>
              <div className={styles.filter}>
                ...
                >
                  ...
                  <option value={'Grupa przedszkolna'}>
                    grupa przedszkolna
                  </option>
                  <option value={'Grupa początkująca'}>
                    grupa początkująca
                  </option>
          ...
          <p className='smaller'>
            ...
            szukają wymówek i chcą aktywnie spędzać wolny czas, dbając tym samym
            o dobrą formę i samopoczucie.{' '}
          </p>
          <br />
          <p className='smaller'>
