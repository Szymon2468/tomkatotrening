  ...
  return (
    <>
      <NextSeo
        ...
        description='tomkatotrening - informacje o Oyama Karate'
        canonical='https://www.tomkatotrening.pl/informacje/Oyama-Karate'
      />
        ...
        <div className={classNames('container', styles.gridContainer)}>
          ...
          <div className={styles.info}>
            <p>
              ...
              oryginalne formy z bronią (Bo, Tonfa i Sai). Są przedmiotem
              studiów, praktyki oraz jednym z najważniejszych czynników
              pozwalających pojmować styl Oyama jako sztukę walki oraz
              oryginalną dyscyplinę sportu.
            </p>
            <br />
            <p>
